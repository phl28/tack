...
One file, every harness. The plugins link this to `~/.claude/CLAUDE.md`,
`~/.codex/AGENTS.md`, `~/.gemini/GEMINI.md` and so on, so the prose you write
here is what every agent reads.
